  ...
  return (
    isRendering && (
      <div className="policyWrapper">
        ...
        <p>
          이 약관은 주식회사 에이아이에스(이하 “회사”라 합니다)가 크롬 브라우저
          등 웹 브라우져 및 모바일 기기 등(이하 “모바일 기기”라 하며, 아래에서
          별도로 정의합니다)을 통해 제공하는 농작물 재배 관리 서비스 “잘키움” 및
          이에 부수하는 애플리케이션, 네트워크, 웹사이트 등 서비스(이하,
          통칭하여 “서비스”라 합니다)의 이용에 대한 회사와 서비스 이용자의
          권리ㆍ의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
        </p>
        <div style={{ marginBottom: 8, marginTop: 15 }}>
          <h3>제2조 (용어의 정의)</h3>
        </div>
        <ul>
          ...
          <ul>
            ...
            <li>
              3. “이용자”란 회원 및 회원으로서 이 약관에 따라 이용계약을
              체결하기 전 회사가 제공하는 서비스(가입 절차를 포함합니다)를
              이용하는 자를 의미합니다.
            </li>
            <li>
              4. “모바일 기기”란 서비스를 다운로드 받거나 설치하여 사용할 수
              있는 기기로서, 노트북, 휴대폰, 스마트폰, 휴대정보단말기(PDA),
              태블릿, 각종 디지털기기 등을 의미합니다.
            </li>
            <li>
              5. “계정정보”란 회원의 회원번호와 외부계정정보, 기기정보,
              재배경력, 작기 정보 등 농장운영 정보, 이메일주소, 이름, 전화번호,
              농장주소, 이용요금 결제 정보, 온실내 설치기기 정보 등 회원이
              회사에 제공한 정보와, 이용요금 결제 정보 등을 통칭합니다.
            </li>
            <li>
              6. “오픈마켓”이란 모바일 기기에서 서비스를 설치하고 결제할 수
        ...
        <p>
          ...
          표시합니다. 다만, 개인정보처리방침과 약관은 회원이 연결화면을 통하여
          볼 수 있도록 할 수 있습니다.
        </p>
        <ul>
        ...
        <ul>
          ...
          <li>
            ...
            현행약관과 함께 서비스 내 또는 그 연결화면에 그 적용일자 7일
            이전부터 적용일자 전일까지 공지 또는 통지합니다. 다만, 회원에게
            불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전
            유예기간을 두고 공지 또는 통지합니다.
          </li>
          <li>
            ③ 회사가 전항에 따라 개정약관을 공지 또는 통지하면서, 약관 변경
            적용일까지 거부의사를 표시하지 아니할 경우 약관의 변경에 동의한
            것으로 간주한다는 내용을 회원에게 명확하게 공지 또는 통지하였음에도
            회원이 명시적으로 거부의 의사표시를 하지 않은 경우, 회원이
            개정약관에 동의한 것으로 간주합니다.
          </li>
          <li>
            ④ 회원이 개정약관의 적용에 동의하지 않는 경우 회사는 개정약관의
            내용을 적용할 수 없으며, 이 경우 회원은 이용계약을 해지할 수
            있습니다. 다만, 회사가 개정약관에 부동의한 회원에게 기존 약관을
            적용할 수 없는 경우, 회사는 해당 회원과의 이용계약을 해지할 수
            있으며, 이 경우 로그인 후 제공되는 서비스를 이용할 수 없습니다.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            약관의 내용에 대하여 동의를 한 다음 서비스 이용 신청을 하고, 회사가
            그 신청에 대해서 승낙함으로써 체결됩니다.
          </li>
          <li>
            ② 이용자가 만 14세미만인 경우에는 법정대리인의 동의를 받아 이용
            신청을 할 수 있으며 동의서를 첨부하여 이용 신청을 하여야 합니다.
          </li>
          <li>
            ③ 전항의 경우 만 14세미만 이용자의 부모 등 법정대리인은 아동에 대한
            개인정보의 열람, 정정, 갱신을 요청하거나 회원가입에 대한 동의를
            철회할 수 있으며, 이 경우 회사는 지체 없이 필요한 조치를 취해야
            합니다.
          </li>
          <li>
          ...
          <ul>
            ...
            <li>
              3. 「콘텐츠산업진흥법」등 관련 법령에서 금지하는 행위를 할
              목적으로 신청하는 경우
            </li>
            <li>
            ...
            <li>
              8. 회사로부터 서비스 이용 정지 조치 등을 받은 자가 그 조치기간
          ...
          <ul>
            <li>
              1. 회사의 설비에 여유가 없거나, 특정 모바일 기기의 지원이
              어렵거나, 기술적 장애가 있는 경우
            </li>
            <li>
        ...
        <ul>
          <li>
            ...
            위해 노력하며, 개인정보의 보호 및 사용에 대해서는 관련 법령 및
            회사의 개인정보처리방침에 따릅니다. 다만, 회사가 제공하는 서비스
            이외의 링크된 서비스에서는 회사의 개인정보처리방침이 적용되지
            않습니다.
          </li>
          <li>
        ...
        <ul>
          ...
          <ul>
            ...
            <li>
              ...
              게시하거나 메일을 발송하는 행위, 타인으로 가장하거나 타인과의
              관계를 허위로 명시하는 행위거나 다른 이용자에게 혼란을 초래하는
              행위
            </li>
            <li>
            ...
            <li>
              5. 다른 회원의 개인정보를 무단으로 수집⋅저장⋅게시 또는 유포하는
              행위
            </li>
            <li>
            ...
            <li>
              ...
              등을 고의로 전송⋅게시⋅유포 또는 사용하는 행위, 회사가 제공하는
              서비스 프로그램의 이용방식, 기획의도를 변경하거나 서비스에
              비정상적으로 위해를 가하거나 고의로 방해하는 일체의 행위
            </li>
            <li>
            ...
            <li>
              ...
              비정상적인 방식으로 쿠폰, 이벤트 혜택 등의 경제상의 이익을
              수취하는 행위
            </li>
            <li>
              15. 부정한 목적으로 다량의 정보를 전송하여 서비스의 안정적인
              운영을 방해하는 행위
            </li>
            <li>
          ...
          <li>
            ② 회원의 계정 및 모바일 기기에 관한 관리 책임은 회원에게 있으며,
            이를 타인이 이용하도록 하게 하여서는 안 됩니다. 모바일 기기의 관리
            부실이나 타인에게 이용을 승낙함으로 인해 발생하는 손해에 대해서
            회사는 책임을 지지 않습니다.
          </li>
          <li>
        ...
        <ul>
          <li>
            ① 회사가 제공하는 서비스 내 프로그램의 내용은 다음과 같습니다.
          </li>
          <ul>
        ...
        <ul>
          <li>
            ① 서비스는 회사의 영업방침에 따라 정해진 시간 동안 제공합니다.
            회사는 서비스 제공시간을 애플리케이션 등의 초기화면이나 서비스
            공지사항에 적절한 방법으로 안내합니다.
          </li>
          <li>
            ② 제1항에도 불구하고 회사는 다음 각 호의 경우에는 서비스의 전부 또는
            일부를 일시 정지할 수 있습니다. 이 경우 회사는 사전에 그 정지의
            사유와 기간을 애플리케이션 등의 초기화면이나 서비스 공지사항 등에
          ...
          <ul>
            ...
            <li>
              2. 정전, 서비스 설비의 장애, 서비스 이용폭주, 기간통신사업자의
          ...
          <li>
            ...
            이용할 수 있습니다. 애플리케이션 등을 다운로드하거나 서비스를
            이용하는 경우에는 가입한 이동통신사에서 정한 별도의 요금이 발생할 수
            있습니다.
          </li>
          <li>
            ⑤ 애플리케이션 등을 이용하는 서비스의 경우에는 모바일 기기 또는
            이동통신사의 특성에 맞도록 제공됩니다. 모바일 기기의 변경․번호 변경
            또는 해외 로밍의 경우에는 프로그램의 전부 또는 일부의 이용이
            불가능할 수 있으며, 이 경우 회사는 책임을 지지 않습니다.
          </li>
          <li>
            ⑥ 애플리케이션 등을 통해 이용하는 서비스의 경우에는 백그라운드
            작업이 진행될 수 있습니다. 이 경우 모바일 기기 또는 이동통신사의
            특성에 맞도록 추가요금이 발생할 수 있으며 이와 관련하여 회사는
            책임을 지지 않습니다.
          </li>
        </ul>
        <div style={{ marginTop: 15 }}>
        ...
        <ul>
          <li>
            ...
            공지합니다. 다만, 버그․오류 등의 수정이나 긴급 업데이트 등
            부득이하게 변경할 필요가 있는 경우 또는 중대한 변경에 해당하지 않는
            경우에는 사후에 공지할 수 있습니다.
          </li>
          <li>
            ...
            등을 애플리케이션 등 초기화면 또는 그 연결화면을 통해 공지하고
            제27조 제1항의 방법으로 회원에게 통지합니다.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            데이터(농가의 환경, 농장정보, 농장주소, 재배면적, 재배작물,
            작기정보를 포함한 재배정보, 경경 잎면적 등을 포함한 작물 생육 정보,
            온도, 습도, 풍향, 풍속, 일사량, 강우량, 토양 센서 데이터 등을
            포함하나 개인정보보호법에 따라 보호받는 개인정보는 제외함, 이하
            “회원 제공 데이터”)를 회사 클라우드 서버에 전송, 저장하고 이용할 수
            있습니다.
          </li>
          <li>
          ...
          <ul>
            ...
            <li>
              2. 회원 제공 데이터 이용 용도 - 상업적 또는 비상업적 이용을
              구분하지 않음.
            </li>
            <li>
              3. 회원 제공 데이터 이용 범위 - 국내 및 국외에서의 복제, 수정,
              각색, 공연, 전시, 방송, 배포, 대여, 공중송신, 2차적 저작물 작성,
              기타 이용
            </li>
            <li>
        ...
        <ul>
          <li>
            ...
            마크, 로고, 디자인, 서비스명칭, 정보 및 상표 등과 관련된 지적재산권
            및 기타 권리는 회사에 소유권 및 지적재산권이 있습니다.
          </li>
          <li>
            ② 회원은 회사가 제공하는 서비스를 이용하여 얻은 정보 중에서 회사
            또는 제공업체에 지적재산권이 귀속된 정보를 회사 또는 제공업체의 사전
            동의 없이 복제⋅전송 등의 방법(편집, 공표, 공연, 배포, 방송, 2차적
            저작물 작성 등을 포함합니다. 이하 같습니다)에 의하여 영리목적으로
            이용하거나 타인에게 이용하게 하여서는 안 됩니다.
          </li>
          <li>
            ③ 회원 제공 데이터에 대한 소유권 및 지적재산권은 회원에게 있습니다.
            그러나, 회원은 이 약관이 정하는 바에 따라 회사가 지정하는 제3자가
            회원 제공 데이터를 이용하는 것을 허락합니다.
          </li>
          <ul>
            <li>1. 회원 제공 데이터의 열람</li>
            <li>
              2. 회원 제공 데이터의 분석 및 통계작성, 기술 개발 기타 서비스
              개선을 위한 목적으로 학술, 연구기관 업체에게 제공하여 국내 및
              국외에서의 복제, 수정, 각색, 공연, 전시, 방송, 배포, 대여,
              공중송신, 2차적 저작물 작성, 기타 이용
            </li>
            <li>
        ...
        <ul>
          ...
          <li>
            ...
            대하여도 회사는 책임을 지지 않습니다. 다만, 회사가 고의 또는
            중과실로 손해의 발생을 용이하게 하거나 손해 방지를 위한 조치를
        ...
        <ul>
          <li>
            ① 서비스 내에서 회원이 구매한 유료 프로그램은 모바일 기기에서만
            이용할 수 있습니다.
          </li>
          <li>
        ...
        <ul>
          <li>
            ① 회원은 제10조에 따른 회원의 의무를 위반하는 행위를 하여서는 안
            되며, 해당 행위를 하는 경우에 회사는 다음 각 호의 구분에 따른 회원의
            서비스 이용제한 및 기타의 조치를 포함한 이용제한 조치를 할 수
            있습니다. 이용제한 조치가 이루어지는 구체적인 사유 및 절차는 제19조
            제1항에 따라 개별 서비스의 운영정책에서 정합니다.
          </li>
          <ul>
          ...
          <li>
            ...
            등으로 보상합니다. 다만, 회원이 제3항 각 호의 사유에 해당하는
            경우에는 그러하지 아니합니다.
          </li>
        </ul>
        <div style={{ marginTop: 15 }}>
        ...
        <ul>
          ...
          <li>
            ...
            일반전화결제, 계좌이체, 무통장입금, 선불전자지급수단 결제 등이
            있으며 회사가 제공하는 각 프로그램마다 결제 방법의 차이가 있을 수
            있습니다. 매월 정기적인 결제가 이루어지는 프로그램의 경우 회원
            개인이 해당 서비스의 이용을 중단하고 정기 결제의 취소를 요청하지
            않는 한 매월 결제가 이루어집니다.
          </li>
        </ul>
        <div style={{ marginTop: 15 }}>
        ...
        <ul>
          <li>
            ① 회사와 유료 프로그램의 구매에 관한 계약을 체결한 회원은
            구매계약일과 프로그램 이용 가능일 중 늦은 날부터 7일 이내에 별도의
            수수료‧위약금 등의 부담 없이 청약철회를 할 수 있습니다.
          </li>
          <li>
          ...
          <ul>
            ...
            <li>
              2. 추가혜택이 제공되는 경우에 그 추가 혜택이 사용된 프로그램
            </li>
            <li>
          ...
          <li>
            ...
            경우에는 그 사실을 회원이 쉽게 알 수 있는 곳에 명확하게 표시하고,
            해당 프로그램의 시험사용 상품을 제공(한시적 이용의 허용, 체험용 제공
            등)하거나 이에 대한 제공이 곤란한 경우에는 프로그램에 관한 정보
            제공함으로써 회원의 청약철회의 권리행사가 방해받지 아니하도록
            조치합니다. 만약 회사가 이러한 조치를 하지 아니한 경우에는 제2항 각
            호의 청약철회 제한사유에도 불구하고 회원은 청약철회를 할 수
            있습니다.
          </li>
          <li>
          ...
          <li>
            ⑤ 회원이 청약철회를 할 경우 회사는 플랫폼사업자 또는 오픈마켓
            사업자를 통해 구매내역을 확인합니다. 또한 회사는 회원의 정당한 철회
            사유를 확인하기 위해 회원에게서 제공받은 정보를 통해 회원에게 연락할
          ...
          <li>
            ...
            이 경우 최종 환불은 회원이 유료 프로그램의 구매 대금을 결제한 결제
            수단에 따라 일정이 달라질 수 있습니다.
          </li>
          <li>
            ⑦ 위 제6항에도 불구하고 회원이 앱마켓 결제(인앱결제)를 통해 유료
            프로그램의 구매대금을 결제한 경우, 회사는 앱마켓 결제(인앱결제)에
            대하여 대금지급의 정치, 취소 요청 등 「전자상거래등에서의
            소비자보호에 관한 법률」에 따른 관련 조치를 취합니다. 단, 앱마켓
            결제(인앱결제)의 환불은 해당 앱마켓에서 관리하며, 해당 앱마켓의
            정책에 따라 환불이 진행됩니다.
          </li>
          <li>
            ⑧ 미성년자가 모바일 기기에서 프로그램 구매계약을 체결하는 경우,
            회사는 법정대리인의 동의가 없으면 미성년자 본인 또는 법정대리인이 그
            계약을 취소할 수 있다는 내용을 고지하며, 미성년자가 법정대리인의
            동의 없이 구매계약을 체결한 때에는 미성년자 본인 또는 법정대리인은
            회사에 그 계약을 취소할 수 있습니다. 다만, 미성년자가 법정대리인이
            범위를 정하여 처분을 허락한 재산으로 프로그램을 구매한 경우 또는
        ...
        <ul>
          ...
          <li>
            ④ 환급은 서비스를 이용하고 있는 모바일 기기의 운영체제 종류에 따라
            각 오픈마켓 사업자 또는 회사의 환급정책에 따라 진행됩니다.
          </li>
          <li>
            ⑤ 회사는 과오납금의 환급을 처리하기 위해 회원에게서 제공받은 정보를
            통해 회원에게 연락할 수 있으며, 필요한 정보의 제공을 요청할 수
            있습니다. 회사는 회원으로부터 환급에 필요한 정보를 받은 날부터
            3영업일 이내에 환급합니다.
          </li>
        </ul>
        <div style={{ marginTop: 15 }}>
        ...
        <ul>
          <li>
            ...
            제공할 수 없는 경우에는 서비스 제공에 관하여 책임을 지지 않습니다.
          </li>
          <li>
            ② 회사는 서비스용 설비의 보수, 교체, 정기점검, 공사 등 기타 이에
            준하는 사유로 발생한 손해에 대하여 책임을 지지 않습니다. 다만,
            회사의 고의 또는 과실에 의한 경우에는 그러하지 아니합니다.
          </li>
          <li>
          ...
          <li>
            ...
            손해에 대해서는 책임을 지지 않습니다. 그러나 회사의 고의 또는
            중과실에 의한 경우에는 그러하지 아니합니다.
          </li>
          <li>
          ...
          <li>
            ⑦ 회사는 회원의 등급, 적립금 등의 손실에 대하여 책임을 지지
          ...
          <li>
            ...
            버전의 변경, 해외 로밍, 통신사 변경 등으로 인해 프로그램 전부나
            일부의 기능을 이용할 수 없는 경우 회사는 이에 대해 책임을 지지
            않습니다. 다만, 회사의 고의 또는 과실에 의한 경우에는 그러하지
            아니합니다.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            방법을 서비스 내 또는 그 연결화면에 안내합니다. 회사는 이러한 회원의
            의견이나 불만을 처리하기 위한 전담인력을 운영합니다.
          </li>
          <li>
          ...
          <li>
            ...
            회사는 이용제한 등 회원에게 조치한 사항을 성실히 증명하고,
            조정기관의 조정에 따를 수 있습니다.
          </li>
        </ul>
      </div>
